class AddPdfCustomFields < ActiveRecord::Migration[7.2]
  FIELDS = [
    { name: 'Account Number', field_format: 'string' },
    { name: 'Prepared By',    field_format: 'string' },
    { name: 'NRR (ZMW)',      field_format: 'string' },
    { name: 'MRR (ZMW)',      field_format: 'string' }
  ].freeze
